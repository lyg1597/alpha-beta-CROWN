...
def compute_tile_color(
    ...
    overall_depth_lb = overall_depth_lb[mask,:]
    overall_depth_ub = overall_depth_ub[mask,:]
...
if __name__ == "__main__":
    ...
    res_lb_enlarged.save('pinetree8_lb.png')
    res_ub_enlarged.save('pinetree8_ub.png')
