...
if __name__ == "__main__":
    ...
    cam_inp = view_mats
    cam_ptb = torch.Tensor([[
        [ 4.9800e-05,  0.0000e+00,  9.9838e-03, 0],
        [ 9.9837e-03,  0.0000e+00, -4.9900e-05, 0],
        [ 4.4200e-05,  0.0000e+00, -3.0000e-07, 0],
        [0, 0, 0, 1]
    ]]).to(cam_inp.device)
    cam_inp = cam_inp+cam_ptb
