...
def compute_tile_color(
    ...
    for j in range(0, N, gauss_step):
        ...
        mask_trees_strip_batch = mask_trees_strip[j:j+gauss_step]
        ...
        opacities_rast_ub = opacities_rast.clone()
        opacities_rast_lb[mask_trees_strip_batch,:] = opacities_rast_lb[mask_trees_strip_batch,:]*0.1
        opacities_rast_ub[mask_trees_strip_batch,:] = opacities_rast_ub[mask_trees_strip_batch,:]*0.1+0.1
        lb_alpha = lb_alpha*opacities_rast_lb
        ub_alpha = ub_alpha*opacities_rast_ub
...
if __name__ == "__main__":
    ...
    res_lb_enlarged.save('pinetree4_opacity_lb.png')
    res_ub_enlarged.save('pinetree4_opacity_ub.png')
