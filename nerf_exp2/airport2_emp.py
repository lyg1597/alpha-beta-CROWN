...
eps_lb = torch.Tensor([[0,0,0,-0.0,-0.0,-0.0]]).to('cuda')
eps_ub = torch.Tensor([[0.001,0,0,0.0,0.0,0.0]]).to('cuda')
ts = 64
...
if __name__ == "__main__":
    ...
    # transform = np.array(dt['transform'])
    # scale = dt['scale']
    camera_pose_transformed = transform_ap@camera_pose
    ...
    res_lb_enlarged.save('airport2_emp_lb.png')
    res_ub_enlarged.save('airport2_emp_ub.png')
