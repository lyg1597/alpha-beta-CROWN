...
if __name__ == "__main__":
    ...
    eps_ub = torch.Tensor([[0,0,0,scale*0.01,scale*0.01,scale*0.01]]).to(means.device)
    ts = 64
    gauss_step = 10000
    ...
    res_lb_enlarged.save('pinetree4_emp_lb.png')
    res_ub_enlarged.save('pinetree4_emp_ub.png')
